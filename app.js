...
const WORDS = {
  hy:{nav:["Գլխավոր","Մենյու","Խաղ","Մեր մասին","Կապ"],kicker:"TASTY • TOASTY • CRUSTY",title:"Քո սենդվիչը։<br>Քո կանոններով։",intro:"Թարմ բաղադրիչներ, ոսկեգույն խրթխրթան հաց և համեր, որոնց համար ուզում ես վերադառնալ։",menuButton:"Դիտել մենյուն",openDaily:"Ամեն օր",menuItems:"ընտրություն մենյուում",hours:"Ամեն օր՝ 10:00–22:00",orderTitle:"Ընտրիր առաքման եղանակը",orderText:"Մենյուն դիտիր այստեղ, իսկ պատվերը կատարիր քեզ հարմար հարթակում։",menuKicker:"ԱՄԲՈՂՋ ՄԵՆՅՈՒՆ",menuTitle:"Ամեն ինչ՝ մեկ տեղում։",menuIntro:"Բոլոր սենդվիչները, կոմբոները, խորտիկները, աղցանները, սոուսները և ըմպելիքները։",viewAll:"Դիտել բոլորը",heroGameKicker:"ՀԱՎԱՔԻՐ • ՀԱՍՑՐՈՒ • ՀԱՂԹԻՐ",heroGameMeta:"30 վայրկյան • 3 կյանք",heroGameButton:"ԽԱՂԱԼ ՀԻՄԱ",aboutKicker:"ՄԵՐ ՄԱՍԻՆ",aboutTitle:"Պատրաստվում է հենց քո աչքի առաջ",aboutText:"Crusty Sandwiches & More-ը Երևանի սրտում ստեղծված արագ ու թարմ սննդի կոնցեպտ է։ Յուրաքանչյուր պատվերը պատրաստում ենք տեղում։",pointFresh:"Թարմ բաղադրիչներ ամեն օր",pointMade:"Պատրաստվում է պատվերից հետո",pointChoice:"Քո ընտրությունը՝ քո կանոններով",gamePromoTitle:"Հավաքիր։ Հասցրու։ Հաղթիր։",gamePromoText:"30 վայրկյանում հավաքիր ճիշտ պատվերը, պահպանիր երեք կյանքը և դարձիր Crusty Master։",promoKicker:"ԱԿՑԻԱՆԵՐ",promoCardTitle:"Հետևիր հատուկ առաջարկներին",promoCardText:"Նոր կոմբոներ, սեզոնային համեր և հատուկ առաջարկներ՝ մեր սոցիալական էջերում։",jobsKicker:"ԱՇԽԱՏԱՆՔ",jobsTitle:"Միացիր Crusty թիմին",jobsText:"Սիրո՞ւմ ես արագ աշխատանք, լավ սնունդ և ուժեղ թիմ։ Կապվիր մեզ հետ։",callUs:"Զանգահարել ↗",address:"Մաշտոցի պողոտա 5, Երևան 0002",map:"Բացել քարտեզը ↗",rushTitle:"CRUSTY RUSH",rushHint:"Հիշիր պատվերը և հավաքիր բաղադրիչները ճիշտ հերթականությամբ։",orderLabel:"ՊԱՏՎԵՐ",timerLabel:"ԺԱՄԱՆԱԿ",livesLabel:"ԿՅԱՆՔԵՐ",scoreLabel:"ՄԻԱՎՈՐ",gameReset:"Նորից",rushStart:"ՍԿՍԵԼ ԽԱՂԸ"},
  ru:{nav:["Главная","Меню","Игра","О нас","Контакты"],kicker:"TASTY • TOASTY • CRUSTY",title:"Твой сэндвич.<br>Твои правила.",intro:"Свежие ингредиенты, золотистый хрустящий хлеб и вкусы, за которыми хочется возвращаться.",menuButton:"Смотреть меню",openDaily:"Каждый день",menuItems:"позиций в меню",hours:"Каждый день: 10:00–22:00",orderTitle:"Выберите способ заказа",orderText:"Смотрите всё меню здесь, а заказ оформляйте на удобной платформе.",menuKicker:"ПОЛНОЕ МЕНЮ",menuTitle:"Всё меню — прямо здесь.",menuIntro:"Все сэндвичи, комбо, закуски, салаты, соусы и напитки по разделам.",viewAll:"Посмотреть все",heroGameKicker:"СОБЕРИ • УСПЕЙ • ПОБЕДИ",heroGameMeta:"30 секунд • 3 жизни",heroGameButton:"ИГРАТЬ СЕЙЧАС",aboutKicker:"О НАС",aboutTitle:"Готовим прямо на твоих глазах",aboutText:"Crusty Sandwiches & More — концепция быстрой и свежей еды в центре Еревана. Каждый заказ готовим на месте.",pointFresh:"Свежие ингредиенты каждый день",pointMade:"Готовим только после заказа",pointChoice:"Твой выбор — твои правила",gamePromoTitle:"Собери. Успей. Победи.",gamePromoText:"За 30 секунд собери правильный заказ, сохрани три жизни и стань Crusty Master.",promoKicker:"АКЦИИ",promoCardTitle:"Следи за специальными предложениями",promoCardText:"Новые комбо, сезонные вкусы и специальные предложения — в наших социальных сетях.",jobsKicker:"ВАКАНСИИ",jobsTitle:"Присоединяйся к команде Crusty",jobsText:"Любишь быстрый ритм, хорошую еду и сильную команду? Свяжись с нами.",callUs:"Позвонить ↗",address:"проспект Месропа Маштоца, 5, Ереван 0002",map:"Открыть карту ↗",rushTitle:"CRUSTY RUSH",rushHint:"Запомни заказ и собери ингредиенты в правильном порядке.",orderLabel:"ЗАКАЗ",timerLabel:"ВРЕМЯ",livesLabel:"ЖИЗНИ",scoreLabel:"СЧЁТ",gameReset:"Заново",rushStart:"НАЧАТЬ ИГРУ"},
  en:{nav:["Home","Menu","Game","About","Contact"],kicker:"TASTY • TOASTY • CRUSTY",title:"Your sandwich.<br>Your rules.",intro:"Fresh ingredients, golden crusty bread and flavors worth coming back for.",menuButton:"Explore menu",openDaily:"Open daily",menuItems:"menu choices",hours:"Open daily: 10:00–22:00",orderTitle:"Choose how to order",orderText:"Browse the full menu here, then order on the platform you prefer.",menuKicker:"FULL MENU",menuTitle:"The whole menu. Right here.",menuIntro:"Every sandwich, combo, bite, salad, sauce and drink, organized by category.",viewAll:"View all",heroGameKicker:"BUILD • RACE • WIN",heroGameMeta:"30 seconds • 3 lives",heroGameButton:"PLAY NOW",aboutKicker:"OUR STORY",aboutTitle:"Made fresh, right in front of you",aboutText:"Crusty Sandwiches & More is a fast, fresh food concept in central Yerevan. Every order is made on the spot.",pointFresh:"Fresh ingredients every day",pointMade:"Made only after you order",pointChoice:"Your choice — your rules",gamePromoTitle:"Build. Race. Win.",gamePromoText:"Build the right order in 30 seconds, protect your three lives and become a Crusty Master.",promoKicker:"OFFERS",promoCardTitle:"Follow our special offers",promoCardText:"New combos, seasonal flavors and limited offers on our social channels.",jobsKicker:"CAREERS",jobsTitle:"Join the Crusty team",jobsText:"Love a fast pace, great food and a strong team? Get in touch with us.",callUs:"Call us ↗",address:"5 Mesrop Mashtots Ave, Yerevan 0002",map:"Get directions ↗",rushTitle:"CRUSTY RUSH",rushHint:"Remember the order and stack every ingredient in the right sequence.",orderLabel:"ORDER",timerLabel:"TIME",livesLabel:"LIVES",scoreLabel:"SCORE",gameReset:"Restart",rushStart:"START GAME"}
};
...
function setLanguage(next){
  ...
  document.querySelectorAll("[data-nav]").forEach((el,i)=>{if(w.nav[i])el.textContent=w.nav[i]});
  renderMenu();
  renderBuilderLabels();
}
...
function menuPreviewLimit(){return window.innerWidth<=760?2:window.innerWidth<=1100?3:4}
function renderMenu(){
  ...
  const limit=menuPreviewLimit();
  document.getElementById("menuRoot").innerHTML=ORDER.map(c=>{
    const items=products.filter(p=>p.category===c);if(!items.length)return "";const preview=items.slice(0,limit);
    return '<section class="menu-category reveal" id="'+slug(c)+'"><div class="category-heading"><div><h3>'+CATEGORIES[c][lang]+'</h3><span>'+items.length+'</span></div><button class="category-open" type="button" data-open-category="'+c+'"><b>'+WORDS[lang].viewAll+'</b><i>↗</i></button></div><div class="menu-grid">'+preview.map(cardMarkup).join("")+'</div></section>';
  }).join("");
  setupReveals();
...
document.querySelectorAll("[data-open-game]").forEach(button=>button.addEventListener("click",openBuilderGame));
...
let menuResizeTimer;window.addEventListener("resize",()=>{clearTimeout(menuResizeTimer);menuResizeTimer=setTimeout(renderMenu,180)});
